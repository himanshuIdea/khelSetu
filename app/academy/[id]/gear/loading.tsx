        ...
        <div className="flex flex-col lg:flex-row gap-3 lg:gap-[5px]">
          <div className="flex-1 min-w-0 space-y-4">
            <div className="space-y-2">
              <div className="h-7 w-56 bg-line2 rounded-lg" />
            ...
            <div className="hidden lg:block border border-line rounded-(--radius) overflow-hidden">
              ...
              {Array.from({ length: 6 }).map((_, index) => (
                ...
                >
                  ...
                  <div className="flex-1 h-3.5 bg-line2 rounded max-w-[180px]" />
          ...
          <div className="w-full lg:w-[316px] shrink-0 space-y-3.5">
            <div className="h-72 bg-line2 rounded-(--radius)" />
            <div className="h-48 bg-line2 rounded-(--radius)" />
            <div className="h-40 bg-line2 rounded-(--radius)" />
          </div>
        </div>
      </div>
    </PageBody>
