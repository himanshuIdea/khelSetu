  ...
  return (
    <PageBody className="flex flex-col min-h-0 flex-1 lg:max-h-[calc(100dvh-66px)] lg:overflow-hidden">
      <div className="flex flex-col flex-1 min-h-0 min-w-0 w-full animate-pulse" aria-busy aria-label="Loading tournaments">
        ...
        <div className="bg-card border border-line rounded-(--radius) shadow-card p-4 sm:p-5 mb-4 flex gap-4">
        ...
        <SplitLayout className="flex-1 lg:min-h-0 lg:overflow-hidden">
          <div className="flex-1 min-w-0 bg-card border border-line rounded-(--radius) shadow-card p-4 sm:p-5 lg:min-h-0 lg:overflow-y-auto">
          ...
          <SidePanel className="lg:min-h-0 lg:max-h-full">
            <div className="bg-card border border-line rounded-(--radius) shadow-card p-4 sm:p-[18px] space-y-3 lg:max-h-full lg:overflow-y-auto">
