        ...
        <div className="flex-1 min-w-0 w-full animate-pulse" aria-busy aria-label="Loading players">
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 mb-4">
            <div className="space-y-2">
              <div className="h-7 w-28 bg-line rounded-lg" />
              <div className="h-4 w-72 max-w-full bg-line rounded" />
            </div>
            ...
            {Array.from({ length: 6 }).map((_, i) => (
              <div key={i} className="flex items-start gap-3 px-3.5 py-3.5 min-w-0">
                ...
                <div className="flex-1 min-w-0 space-y-1.5">
                  <div className="h-3.5 w-36 max-w-full bg-line rounded" />
                  <div className="h-3 w-28 max-w-full bg-line rounded" />
                  <div className="h-3 w-32 max-w-full bg-line rounded" />
                  <div className="flex gap-2 pt-1">
                    <div className="h-6 w-16 bg-line rounded-full shrink-0" />
                    <div className="h-6 w-20 bg-line rounded-full shrink-0" />
                  </div>
                </div>
              </div>
            ))}
          ...
          <div className="hidden lg:block border border-line rounded-(--radius) overflow-hidden min-w-0 w-full">
            ...
            {Array.from({ length: 6 }).map((_, i) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0 space-y-1.5">
                  <div className="h-3.5 w-36 max-w-full bg-line rounded" />
                  <div className="h-3 w-24 max-w-full bg-line rounded" />
                </div>
                <div className="h-6 w-16 bg-line rounded-full shrink-0" />
                <div className="h-3 w-10 bg-line rounded shrink-0" />
                <div className="h-6 w-14 bg-line rounded-full shrink-0" />
              </div>
            ))}
          </div>
        </div>
