  ...
  return (
    <PlayerScreen>
      <div className="flex items-center gap-3 px-[18px] pb-3.5 shrink-0">
        <Link href="/player/home" className="w-[38px] h-[38px] rounded-[11px] bg-card border border-line flex items-center justify-center text-ink">
          <BackIcon />
        </Link>
        <div className="text-[17px] font-bold text-ink">Today&apos;s Drill</div>
        <Link href="/player/ai-form" className="ml-auto text-[11px] font-semibold text-brand">
          AI Form Check →
        </Link>
      </div>
