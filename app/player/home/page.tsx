...
export default function PlayerHomePage() {
  return (
    <PlayerScreen>
      ...
      <div className="flex gap-2 px-[18px] pb-3 overflow-x-auto overscroll-x-contain shrink-0 [-webkit-overflow-scrolling:touch] [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
        {categories.map((c, i) => (
          <span
            key={c}
