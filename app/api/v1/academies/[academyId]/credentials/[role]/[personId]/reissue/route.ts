...
export async function POST(_request: Request, context: RouteContext) {
  try {
    ...
    const result = await reissueTemporaryPassword(academyId, segment, personId);
    ...
    const message = error instanceof Error ? error.message : "Could not reissue credentials";
