...
export default function MobileAiFormPage() {
  return (
    <PhoneShell showTabBar={false}>
      <div className="flex items-center gap-3 px-[18px] pb-3.5 shrink-0">
        <Link href="/mobile/drills" className="w-[38px] h-[38px] rounded-[11px] bg-card border border-line flex items-center justify-center text-ink">
          <BackIcon />
        </Link>
