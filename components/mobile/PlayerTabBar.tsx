...
import { playerRoutes, type PlayerNavItem } from "@/lib/player-nav";

type PlayerTabBarProps = {
  activeItem: PlayerNavItem;
};

const tabs: { id: PlayerNavItem; label: string; icon: React.ReactNode; fab?: boolean }[] = [
...
export function PlayerTabBar({ activeItem }: PlayerTabBarProps) {
  return (
    <nav
...
/** @deprecated Use `PlayerTabBar`. */
export function MobileTabBar(props: PlayerTabBarProps) {
  return <PlayerTabBar {...props} />;
}
