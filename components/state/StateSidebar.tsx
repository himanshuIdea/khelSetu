  ...
  return (
    <Link
      ...
      className={`flex items-center gap-[11px] px-3 py-2.5 rounded-[11px] text-[13.5px] font-medium mb-[3px] transition-colors ${
        active ? "bg-ink3 text-white" : "text-[#aeb8d0] hover:text-white"
      }`}
    >
...
export function StateSidebar({
  ...
  const overviewNav: NavEntry[] = [
    ...
    { id: "scouting", label: "Talent scouting", href: `${base}/scouting`, icon: <SearchIcon className="w-[18px] h-[18px]" /> },
  ];

  const governanceNav: NavEntry[] = [
    { id: "verification", label: "Verification", href: `${base}/verification`, icon: <ShieldIcon className="w-[18px] h-[18px]" /> },
    { id: "funds", label: "Fund utilisation", href: `${base}/funds`, icon: <CashIcon /> },
    { id: "districts", label: "Districts", href: `${base}/districts`, icon: <PinIcon className="w-[18px] h-[18px]" /> },
      ...
      <div className="flex items-center justify-between px-1.5 pb-[22px]">
        <div className="flex items-center gap-2.5">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-[8.5px] font-bold tracking-[1px] bg-ink3 text-[#9DB0D8] px-1.5 py-0.5 rounded-[5px]">
              STATE
            </span>
          </div>
        </div>
